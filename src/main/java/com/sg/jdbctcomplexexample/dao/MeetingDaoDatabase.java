...
public class MeetingDaoDatabase implements  MeetingDao{
    ...
    public Meeting getMeetingByid(int id) {
        try{
            final String SELECT_MEETING_BY_ID = "SELECT  * FROM  meeting WHER id = ? ";
...
private  static final class MeetingMapper implements RowMapper<Meeting>{
    ...
    private Room getRoomForMeeting(Meeting meeting) {
        ...
        return jdbc.queryForObject(SELECT_ROOM_FOR_MEETING, new RoomDaoDatabase.RoomMapper(),
                meeting.getId());
    }
    ...
    private List<Employee> getEmployeesForMeeting(Meeting meeting) {
        ...
        return jdbc.query(SELECT_EMPLOYEES_FOR_MEETING, new EmployeeDaoDatabase.EmployeeMapper(),
                meeting.getId());
    }
